  ...
  const  deletecart = async ()=>{
    ...
    return (
      ...
      <Container>
        ...
        <Info>
          <Text style={{ fontWeight:'bolder' , fontSize:'12px' }} >{item?.title}</Text>
          
          <Info   style={{width:'100px',  display:'flex', maxWidth:'200px', justifyContent:'center', alignItems:'center' ,outline:'1px solid #9f9f9f', flexWrap:'wrap' }} >
            <Text style={{marginBottom:'0px'}}  >Quantity</Text>
            <Info style={{ display:'flex', justifyContent:'center', alignItems:'center', gap:'5px' }} >
            <MdArrowLeft onClick={()=>increaseQuantity('dec')}  style={{fontSize:'30px' , cursor:'pointer' }} />
           <Text>{incrq}</Text>
